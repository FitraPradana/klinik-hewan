        ...
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="kd_product" class="col-lg-2 col-lg-offset-1 control-label">Kode Product</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="nm_product" class="col-lg-2 col-lg-offset-1 control-label">Nama Product</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="purchase_price" class="col-lg-2 col-lg-offset-1 control-label">Purchase
                            Price</label>
                        <div class="col-lg-3">
